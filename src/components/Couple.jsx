            ...
            <div className="row">
                <div className="col-lg-5" data-aos="fade-up">
                    ...
                    <div className="info groom-info">
                        <h3>A.S. Abdul Azeez,</h3>

                        <p>
                            S/O Janab Shaikh Mehboob Sahab
                            <br />
                            Grand S/O Janab A. Abdul Hameed Sahab(Late)
                            <br />
                            Basapura Road, Azeez Compound,
                            <br />
                            Ramapura, Molakalmuru (TQ).
                        </p>
                    </div>
                </div>
                <div
                ...
                <div className="col-lg-5" data-aos="fade-up">
                    ...
                    <div className="info">
                        <h3>Nazia Sultana,</h3>
                        <p>
                            D/O Janab Akbar Hussain Sahab(Late)
                            <br />
                            Grand D/O Janab Abid Hussain Sahab(Late)
                            <br /> Adoni.
                        </p>
                    </div>
                </div>
